...
func RegisterPetServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PetServiceServer) error {
	...
	mux.Handle("GET", pattern_PetService_GetPet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/hashipet.v1.PetService/GetPet", runtime.WithHTTPPathPattern("/v1/pet/{name}"))
		if err != nil {
		...
		forward_PetService_GetPet_0(ctx, mux, outboundMarshaler, w, req, response_PetService_GetPet_0{resp}, mux.GetForwardResponseOptions()...)
...
func RegisterPetServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PetServiceClient) error {
	...
	mux.Handle("GET", pattern_PetService_GetPet_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/hashipet.v1.PetService/GetPet", runtime.WithHTTPPathPattern("/v1/pet/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_PetService_GetPet_0 struct {
	proto.Message
}

func (m response_PetService_GetPet_0) XXX_ResponseBody() interface{} {
	response := m.Message.(*GetPetResponse)
	return response.Pet
}

var (
	pattern_PetService_GetPet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "pet", "name"}, ""))
)
